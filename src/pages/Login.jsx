...
const Login = () => {
  return (
    ...
    <Form method='post' className='card w-96 p-8 bg-base-100 shadow-lg flex flex-col gap-y4 '>
    ...
    <div className="mt-4">
    <SubmitBtn text="login"  className="mb-4" />

    </div>

    <div className='mt-4'>
    <button type='button' className='btn btn-secondary btn-block'>gust user</button>
